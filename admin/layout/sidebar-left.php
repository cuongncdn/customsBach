<div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li class="user-pro">
                        <a href="#" class="waves-effect"><img src="../plugins/images/user.jpg" alt="user-img" class="img-circle"> <span class="hide-menu"> Tài khoản<span class="fa arrow"></span></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li><a href="settings.php"><i class="ti-settings"></i> Cài đặt tài khoản</a></li>
                            <li><a href="login.php"><i class="fa fa-power-off"></i> Thoát</a></li>
                        </ul>
                    </li>
                    <li class="nav-small-cap m-t-10">--- Danh mục</li>
                    <li> <a href="index.php" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu"> Thống kê </a>
                    </li>
                   ...
                   <li><a href="inbox.php" class="waves-effect"><i data-icon=")" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Tin nhắn</span></a>
                    ...
                    <li><a href="subscribers.php" class="waves-effect"><i data-icon="n" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Khách hàng</span></a>
                    </li>
                    
                     <li class="nav-small-cap">--- Hệ thống</li>
                    <li> <a href="#" class="waves-effect active"><i data-icon="H" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Truy cập<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
